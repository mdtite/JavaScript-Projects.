...
/* This removes a task from the array when its 'x' button is clicked */
function remove() {

    // We grab its ID attribute, which corresponds to its array index.
    var id = this.getAttribute('id');
    var todos = get_todos();
    
    // The splice() method removes 1 item 
    todos.splice(id, 1);
